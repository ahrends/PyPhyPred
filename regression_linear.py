...
This file includes helper functions for linear regression methods for various data distributions.
...
def linear_regression_simple(x,y,train_inds,test_inds, target_type='continuous', regularisation_type='elasticnet', options={}, **kwargs):
    """
